...
2. Download `SubsTrack-0.1.5-sideload.apk`.
...
Android 7.0 or newer is required. Version 0.1.5 upgrades an existing 0.1.4 installation without removing the app. The web version is always available at [substrack.top](https://substrack.top).

The APK checksum is attached to the release and stored in `SubsTrack-0.1.5-sideload.apk.sha256`.
